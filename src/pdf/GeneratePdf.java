...
{
//	public static void generatePdf(ArrayList<Transaction> a)
//	{
//		try
//		{
...
//			paragraph.add("Account Statement");
//			paragraph.add("\n");
//			paragraph.add("\n");
//			paragraph.add("Account Id: " + filename);
//			paragraph.add("\n");
//			paragraph.add("\n");
//			paragraph.add("\n");
//			paragraph.add("\n");
...
//			paragraph1.add("\n");
//			paragraph1.add("\n");
//			paragraph1.add("~TCS_BANK PVT. LTD.");
//			paragraph1.add("\n");
//			paragraph1.add("Thank you for banking with us.");
//			paragraph1.add("\n");
//			paragraph1.add("Copyright © 2020 TCS_BANK");
//			paragraph1.add("\n");
...
//		    basePath = basePath.concat("\\WebContent\\GeneratedPDFs\\"+filename+"_trasactions.pdf");
			...
			paragraph.add("DMM BANK PVT. LTD.");
			paragraph.add("\n");
			paragraph.add("\n");
			document.add(paragraph);
			...
			paragraph1.add("\n");
			paragraph1.add("\n");
			paragraph1.add("~ DMM BANK PVT. LTD.");
			paragraph1.add("\n");
			paragraph1.add("Thank you for banking with us.");
			paragraph1.add("\n");
			paragraph1.add("Copyright © 2020 DMM BANK");
			paragraph1.add("\n");
			paragraph1.add("All rights are reserved.");
			document.add(paragraph1);
			document.close();
